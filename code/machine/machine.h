...
#define TLBFIFOReg      40     //we record the last id replace in the tlb.

#define NumTotalRegs 	41
...
// are in terms of these data structures.
    ...
    FILE *fpMemory; //use a file descritor to desc a file;
...
// the contents of the TLB are free to be modified by the kernel software.
    ...
    void TlbUpdate();// when the pagefault happened,we call this function to update the tlb.
