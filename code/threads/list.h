...
class ListElement {
   public:
     ...
     ListElement *prev; //point to prev element.
...
class List {
  public:
    ...
    ListElement *getElementByKey(int key); //we add use to find the element add by clj
    ListElement *getElementByName(void *name); 
